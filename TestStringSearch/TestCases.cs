...
namespace TestStringSearch
{
    ...
    {
        private static readonly IList<char[]> _simpleCases;
        private static readonly IList<int[]> _simpleCountList;

        #region Properties

        public static IList<char[]> SimpleTestCases
        {
        ...
        public static IEnumerable<char[]> RandomCharArrays(int len, int size)
        {
            for (int i = 0; i < len; ++i)
            {
                yield return RandomChars(size).ToArray();
            }
        }
